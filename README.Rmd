...
- `decompose_sets`: `r lifecycle::badge("experimental")` decompose all pairs of sets into 3 disjoint components: the elements unique to set 1, the elements unique to set 2, and the elements shared by both sets. Not currently used, in practice.
