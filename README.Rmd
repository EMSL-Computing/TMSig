...
- `cameraPR.matrix`: a matrix method for `limma::cameraPR` for testing molecular signatures across one or more contrasts. Pre-Ranked Correlation Adjusted MEan RAnk molecular signature analysis (CAMERA-PR) accounts for inter-molecular correlation to control the type I error rate (Wu & Smyth, 2012).
...
Wu, D., and Smyth, G. K. (2012). Camera: a competitive gene set test accounting for inter-gene correlation. \emph{Nucleic Acids Research} 40, e133. \href{https://doi.org/10.1093/nar/gks461}{doi:10.1093/nar/gks461}.
